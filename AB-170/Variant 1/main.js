...
document.documentElement.dataset.webAb170 = "1";

window.ab170 = window.ab170 || {};

window.ab170.tileDetails =
  window.ab170.tileDetails || {
    imageSrc: "https://placehold.co/537x322/orange/white?text=Halloween+Tile+Variation+1", // TODO - Change placeholder
    tileLink: "https://www.woolworths.co.nz/shop/content/halloween?ab170-var=1"
  };
